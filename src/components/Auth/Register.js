                ...
                <Grid.Column style={{maxWidth: 458}}>
                    ...
                    <Form onSubmit={this.handleSubmit} size="large">
                        <Segment stacked>
                            ...
                            placeholder="Username" onChange={this.handleChnage} value={username} type="text"/>
                            ...
                            placeholder="Password Confirmation" onChange={this.handleChnage} value={passwordConfirmation} className={this.handleInputError(errors, 'password')} type="password"/>
